...
const objects = [
  {
    id: 0,
    cars: 'img/audi.png',
    football: 'img/acm.png',
    cartoons: 'img/bak.png',
  },
  {
    id: 1,
    cars: 'img/bmw.png',
    football: 'img/arsenal.png',
    cartoons: 'img/belka.png',
  },
  {
    id: 2,
    cars: 'img/bugatti.png',
    football: 'img/atletico.png',
    cartoons: 'img/blitz.png',
  },
  {
    id: 3,
    cars: 'img/chevrolet.png',
    football: 'img/barca.png',
    cartoons: 'img/bull.png',
  },
  {
    id: 4,
    cars: 'img/ferrari.png',
    football: 'img/bayern.png',
    cartoons: 'img/burunduk.png',
  },
  {
    id: 5,
    cars: 'img/fiat.png',
    football: 'img/bvb.png',
    cartoons: 'img/cars.png',
  },
  {
    id: 6,
    cars: 'img/ford.png',
    football: 'img/chelsea.png',
    cartoons: 'img/chaika.png',
  },
  {
    id: 7,
    cars: 'img/honda.png',
    football: 'img/everton.png',
    cartoons: 'img/doris.png',
  },
  {
    id: 8,
    cars: 'img/hyundai.png',
    football: 'img/gent.png',
    cartoons: 'img/dragon.png',
  },
  {
    id: 9,
    cars: 'img/infiniti.png',
    football: 'img/inter.png',
    cartoons: 'img/emocii.png',
  },
  {
    id: 10,
    cars: 'img/jaguar.png',
    football: 'img/juventus.png',
    cartoons: 'img/emojif.png',
  },
  {
    id: 11,
    cars: 'img/lamborghini.png',
    football: 'img/leicester.png',
    cartoons: 'img/emojigivefive.png',
  },
  {
    id: 12,
    cars: 'img/lexus.png',
    football: 'img/lion.png',
    cartoons: 'img/filex.png',
  },
  {
    id: 13,
    cars: 'img/mercedes.png',
    football: 'img/liverpool.png',
    cartoons: 'img/frozen.png',
  },
  {
    id: 14,
    cars: 'img/mazda.png',
    football: 'img/psg.png',
    cartoons: 'img/lenivec.png',
  },
  {
    id: 15,
    cars: 'img/mg.png',
    football: 'img/realmadrid.png',
    cartoons: 'img/masha.png',
  },
  {
    id: 16,
    cars: 'img/mini.png',
    football: 'img/stutgard.png',
    cartoons: 'img/moana.png',
  },
  {
    id: 17,
    cars: 'img/mitsubishi.png',
    football: 'img/torino.png',
    cartoons: 'img/nemo.png',
  },
  {
    id: 18,
    cars: 'img/nissan.png',
    football: 'img/tottenham.png',
    cartoons: 'img/olaf.png',
  },
  {
    id: 19,
    cars: 'img/opel.png',
    football: 'img/vilareal.png',
    cartoons: 'img/oldcar.png',
  },
  {
    id: 20,
    cars: 'img/porsche.png',
    football: 'img/wolf.png',
    cartoons: 'img/ralph.png',
  },
  {
    id: 21,
    cars: 'img/romeo.png',
    football: 'img/loko.png',
    cartoons: 'img/rapuncel.png',
  },
  {
    id: 22,
    cars: 'img/rover.png',
    football: 'img/betis.png',
    cartoons: 'img/tiger.png',
  },
  {
    id: 23,
    cars: 'img/subaru.png',
    football: 'img/valencia.png',
    cartoons: 'img/tigress.png',
  },
  {
    id: 24,
    cars: 'img/suzuki.png',
    football: 'img/nice.png',
    cartoons: 'img/venelopa.png',
  },
  {
    id: 25,
    cars: 'img/tesla.png',
    football: 'img/marsel.png',
    cartoons: 'img/white.png',
  },
  {
    id: 26,
    cars: 'img/toyota.png',
    football: 'img/standart.png',
    cartoons: 'img/zootiger.png',
  },
  {
    id: 27,
    cars: 'img/volkswagen.png',
    football: 'img/lazio.png',
    cartoons: 'img/zootopia.png',
  },
]
...
mixedMode.onclick = () => {
  ...
  isMixedModeActive === true
    ? mixedMode.classList.add('active')
...
showRecords.onclick = () => {
  ...
  for (i = 0; i < recordTimeSlots.length; i++) {
    recordTimeSlots[i].innerHTML = JSON.parse(localStorage.getItem('records'))[
      i
    ].time
    recordMovesSlots[i].innerHTML = JSON.parse(localStorage.getItem('records'))[
      i
    ].moves
  }
}
...
function checkDeskSize(quantity) {
  //подгоняем грид под количество карточек
  if (quantity === '12') {
...
function renderGameDesk(quantity) {
...
function randomCardLocation(x) {
  ...
  indexOfCategorie === 0
    ? (nameOfCategorie = 'cartoons')
    : indexOfCategorie === 1
    ? (nameOfCategorie = 'flags')
    : indexOfCategorie === 2
    ? (nameOfCategorie = 'cars')
  ...
  function addImage(i, mode) {
    //рандомно добавляем картинки к карточкам
    ...
    backs[randomNumber1].insertAdjacentHTML(
      //добавляем img к первой карточке и ...
      'afterbegin',
      `
  ...
  cards.forEach((el) => {
    el.onclick = (event) => {
      ...
      if (firstCardInner === null) {
        ...
        if (idOfElement != firstCardId) {
          //если карточка не одна и та же...
  ...
  if (firstCardInner === secondCardInner) {
    ...
    if (remainingCards === 0) {
      ...
      function recordCheck(n) {
        //если рекорд был побит то заносим инфу в рекорды
    ...
    blockCards()
    setTimeout(function () {
      //карточки не совпали,переворачиваем назад
